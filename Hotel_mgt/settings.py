"""
Django settings for Hotel_mgt project.
...
WSGI_APPLICATION = 'Hotel_mgt.wsgi.application'
...
def get_secret_data(settings, secrets=secrets):
    """
    Return secret keys for app or raise ImproperlyConfigured error.
    """
    try:
...
EMAIL_HOST_PASSWORD = get_secret_data("EMAIL_HOST_PASSWORD")
